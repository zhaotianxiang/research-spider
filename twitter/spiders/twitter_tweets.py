...
class MobileTwitter(scrapy.Spider):
    ...
    def active(self, response):
        ...
        self.logger.info('激活游客Token ！！ ----  %s', response_json)
    ...
    def parse_tweets(self, response):
        ...
        for entry in posts:
            if entry.get("content"):
                ...
                if entry["content"]["entryType"] == "TimelineTimelineItem":
                    ...
                    item['dynamics_keywords'] = ''
                    item['dynamics_keyword_cn'] = ''
                    item['dynamics_image_list'] = []
        ...
        try:
            if posts[101]:
                ...
                query_params = '{"userId": "' + response.meta["user"]["id"] + '",\
                        "count": 100,\
                        "cursor": "%s",\
                        "includePromotedContent": false,\
                        "withSuperFollowsUserFields": true,\
