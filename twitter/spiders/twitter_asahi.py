...
class TwitterYoumiuri(CrawlSpider):
    name = 'twitter_asahi_user'
    ...
    def __init__(self):
        ...
        for line in csv.reader(open("./asahi/data/asahi-reporter.csv")):
            self.user_list.add(line[3])
